...
`0.2.29` 的安装目录新增精确 Runner `0.3.29`，并保留 `0.3.28` 与全部原有回滚版本。WSS envelope、存储、连接绑定及既有 ACK 行为不变；App-owned bridge 的未加载任务授权修复只发生在 Runner，Relay 不解析或扩大其权限。本版本当前为发布前候选。
...
- 返回脚本下载固定 installer，核对字节大小和 SHA-256，再下载并核对固定平台 bundle。Relay `0.2.29` 的滚动目录精确接受 Python `3.11.13`、Codex `0.146.0` 与 Runner `0.3.29`，同时保留已冻结的 `0.3.6/0.3.11/0.3.12/0.3.13/0.3.14/0.3.15/0.3.16/0.3.17/0.3.18/0.3.19/0.3.20/0.3.21/0.3.22/0.3.23/0.3.24/0.3.25/0.3.26/0.3.27/0.3.28` bootstrap；其他 Runner 版本仍拒绝。
