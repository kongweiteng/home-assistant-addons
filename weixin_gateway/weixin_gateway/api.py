...
def create_server(
    ...
    *,
    ...
    class Handler(BaseHTTPRequestHandler):
        server_version = "WeixinGateway/0.3.0"
...
<div class="grid"><div class="card">Owner Poller<b id="poller">加载中</b></div><div class="card">ClawBot 身份<b id="identityCount">-</b></div><div class="card">Owner 状态<b id="pairing">加载中</b></div><div class="card">有效用户<b id="activeUsers">-</b></div><div class="card">待提交<b id="pending">-</b></div><div class="card">待回复<b id="submitted">-</b></div></div>
...
<section class="panel"><div class="panel-head"><div><span class="scope identity">运行时</span><h2>ClawBot 身份</h2></div></div><div class="scroll"><table><thead><tr><th>身份</th><th>身份状态</th><th>Poller</th><th>绑定用户</th><th>最近活动/错误</th></tr></thead><tbody id="identitiesBody"></tbody></table></div></section>
...
DASHBOARD_JS = r"""const q=id=>document.getElementById(id);let csrf='',revision=0,currentPairCode='',currentIdentityPresent=false,currentOnboarding='';
