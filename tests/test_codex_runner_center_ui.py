    ...
    def bootstrap(
        ...
        *,
        ...
        return {
            ...
            "asset_url": f"https://downloads.example.com/codex-runner-0.3.3-{os_name}-{arch}.tar.gz",
            "asset_sha256": "a" * 64,
            "asset_size": 123456,
...
class RunnerCenterUiTests(unittest.TestCase):
    ...
    def test_default_enabled_without_relay_and_explicit_false_fail_closed(self) -> None:
        ...
        self.assertEqual(document["version"], "0.5.5")
    ...
    def test_enrollment_revoke_regenerate_and_internal_relay_auth_are_fail_closed(self) -> None:
        ...
        self.assertEqual(bootstrap["result"]["runner_version"], "0.3.3")
