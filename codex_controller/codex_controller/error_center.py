...
_LOCAL_DETAIL_TEXTS: dict[str, tuple[str, str]] = {
    ...
    "bridge_unavailable": ("Runner 当前无法连接 App Bridge Socket。", "确认 Codex App 和 Runner 已恢复，并等待自动重连。"),
    ...
    "bridge_app_pipe_unavailable": ("App Bridge 暂时找不到 Codex App 的本地工具通道。", "确认 Codex App 已登录并正常运行，等待自动重连。"),
    ...
    "bridge_app_unavailable": ("App Bridge 当前无法连接 Codex App 工具通道。", "确认 Codex App 已恢复，并等待自动重连。"),
