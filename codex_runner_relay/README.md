...
`0.2.32` 将安装 renderer 的精确滚动兼容扩展到 Runner `0.3.32`，并完整保留 `0.3.31` 与全部原有回滚版本。Relay 允许并原样转发独立 `desktop_host` 上行，只对 Controller 明确返回的 stale Host 序列安全 ACK；它不解析 Host、Bridge 或任务内容，也不改变连接身份和权限边界。源码发布不代表 HAOS Relay 或 Mac Runner 已完成升级验收。
...
安装 renderer 精确接受 Runner `0.3.32`，并保留已发布 `0.3.6`、`0.3.11`、`0.3.12`、`0.3.13`、`0.3.14`、`0.3.15`、`0.3.16`、`0.3.17`、`0.3.18`、`0.3.19`、`0.3.20`、`0.3.21`、`0.3.22`、`0.3.23`、`0.3.24`、`0.3.25`、`0.3.26`、`0.3.27`、`0.3.28`、`0.3.29`、`0.3.30` 与 `0.3.31` 的滚动兼容；除此之外的版本仍 fail closed。Relay 到 Controller 的 IPv4、Registry/lease 所有权、ticket/enrollment 不落盘、单 Runner 连接绑定和其他错误失败关闭边界保持不变。
