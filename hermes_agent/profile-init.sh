...
RESERVED_VARS="HERMES_HOME|HASS_TOKEN|HASS_URL|HASS_ALLOWED_DOMAINS|HASS_ALLOWED_ENTITIES|HASS_HEALTH_CONFIG_B64|GITHUB_TOKEN|API_SERVER_PORT|API_SERVER_HOST"
