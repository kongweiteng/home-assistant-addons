...
`0.2.30` 将安装 renderer 的精确滚动兼容扩展到 Runner `0.3.30`，并完整保留 `0.3.29` 与全部原有回滚版本。WSS envelope、存储、连接绑定与 ACK 语义不变；大型任务库下的 App-owned Bridge 快速能力发布只发生在 Runner，Relay 不解析或扩大其权限。本版本当前为发布前候选。
...
安装 renderer 精确接受 Runner `0.3.30`，并保留已发布 `0.3.6`、`0.3.11`、`0.3.12`、`0.3.13`、`0.3.14`、`0.3.15`、`0.3.16`、`0.3.17`、`0.3.18`、`0.3.19`、`0.3.20`、`0.3.21`、`0.3.22`、`0.3.23`、`0.3.24`、`0.3.25`、`0.3.26`、`0.3.27`、`0.3.28` 与 `0.3.29` 的滚动兼容；除此之外的版本仍 fail closed。Relay 到 Controller 的 IPv4、Registry/lease 所有权、ticket/enrollment 不落盘、单 Runner 连接绑定和其他错误失败关闭边界保持不变。
