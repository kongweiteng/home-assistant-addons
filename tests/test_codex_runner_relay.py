...
class RelayProtocolUnitTests(unittest.TestCase):
    def test_addon_version_and_controller_hostname_contract_are_exact(self) -> None:
        ...
        self.assertIn('version: "0.2.26"', config)
        self.assertEqual(
            SUPPORTED_RUNNER_VERSIONS,
            frozenset(
                {"0.3.6", "0.3.11", "0.3.12", "0.3.13", "0.3.14", "0.3.15", "0.3.16", "0.3.17", "0.3.18", "0.3.19", "0.3.20", "0.3.21", "0.3.22", "0.3.23", "0.3.24", "0.3.25", "0.3.26"}
            ),
        )
