...
RESERVED_VARS="HERMES_HOME|HASS_TOKEN|HASS_URL|HASS_ALLOWED_DOMAINS|HASS_ALLOWED_ENTITIES|HASS_HEALTH_CONFIG_B64|HA_OPERATIONS_APPROVAL_ENABLED|HA_OPERATIONS_OWNER_IDENTITY_HASHES|HA_OPERATIONS_PROPOSAL_TTL_SECONDS|HA_OPERATIONS_MAX_PENDING|HA_OPERATIONS_LEDGER_PATH|GITHUB_TOKEN|API_SERVER_PORT|API_SERVER_HOST"
