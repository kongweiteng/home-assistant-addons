...
function render(context) {
  if (context.enrollment_enabled && !context.registered_for_user) $("enroll").classList.remove("hidden");
  if (!context.request) {
