...
def create_server(
    ...
    *,
    ...
    class Handler(BaseHTTPRequestHandler):
        server_version = "CodexController/0.5.49"
...
@media(max-width:430px){.topbar{align-items:flex-start}.top-actions{flex-wrap:wrap;justify-content:flex-end}.top-actions .button-link{min-height:44px;padding:8px 10px}.stream-state{order:2}.section-head>a{min-height:44px;display:inline-flex;align-items:center;padding:8px 4px}.runner-actions button,.installation-actions button{min-height:44px}}
